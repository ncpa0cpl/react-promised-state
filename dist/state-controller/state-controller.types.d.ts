export declare type PromisedState<T> = {
...
export declare type PromisedGenerator<T> = (currentValue: Omit<PromisedState<T>, "read">) => T | Promise<T>;
export declare type PromisedStateInitializer<T> = T | (() => T | Promise<T>);
export declare type PromisedSetStateAction<T> = T | Promise<T> | PromisedGenerator<T>;
